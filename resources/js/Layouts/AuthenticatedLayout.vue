...
<template>
 ...
 <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
   ...
   <aside id="separator-sidebar"
    ...
    <center><logo class="block h-9 w-auto fill-current text-gray-800" /></center>
          <ul class="space-y-2 font-medium">
            <li>
               ...
               <li>
                  <ResponsiveNavLink href="/inventories"
               ...
               <li>
                  <ResponsiveNavLink href='/users'
                     ...
                     <span class=" ms-10">Empleados</span>
                  </ResponsiveNavLink>
                  <!--************* AGREGUE PARA LA VISTA DE ROLES ************* -->
                  <ResponsiveNavLink href='/roles'
                     class="flex items-center mt-8 p-2 text-neutral-50 rounded-lg dark:text-white hover:bg-neutral-50 dark:hover:bg-neutral-50 group">
                     <svg xmlns="http://www.w3.org/2000/svg" height="1.5em" fill="orange" viewBox="0 0 20 18">
                        <path
                           d="M14 2a3.963 3.963 0 0 0-1.4.267 6.439 6.439 0 0 1-1.331 6.638A4 4 0 1 0 14 2Zm1 9h-1.264A6.957 6.957 0 0 1 15 15v2a2.97 2.97 0 0 1-.184 1H19a1 1 0 0 0 1-1v-1a5.006 5.006 0 0 0-5-5ZM6.5 9a4.5 4.5 0 1 0 0-9 4.5 4.5 0 0 0 0 9ZM8 10H5a5.006 5.006 0 0 0-5 5v2a1 1 0 0 0 1 1h11a1 1 0 0 0 1-1v-2a5.006 5.006 0 0 0-5-5Z" />
                     </svg>
                     <span class=" ms-10">Roles</span>
                  </ResponsiveNavLink>
               </li>
            </ul>
            <div class=" mt-8">
