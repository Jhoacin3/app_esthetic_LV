        ...
        <div class="py-5 px-15">
          <div class="bg-white px-5 py-8 overflow-hidden shadow-sm sm:rounded-lg">
            ...
            <div class="text-3xl  font-bold text-black">
              <center> Actualizar agenda</center>
            </div>
...
export default {
    ...
    data() {
        return {
            form: {
              fullName: this.agenda.fullName,
              service: this.agenda.service,
                day: this.agenda.day,
                hour: this.agenda.hour,
            },
        };
    },
    methods: {
        async submitForm() {
            try {
                ...
                await this.$inertia.put(route('agendas.update', this.agenda.id), this.form);
                ...
                await Swal.fire({
                    icon: 'success',
                    title: 'Éxito',
                    text: 'Agenda Actualizado Correctamente',
                });
                // VERIFICAR
                ...
                let errorMessage = 'Hubo un error al actualizar la agenda';
